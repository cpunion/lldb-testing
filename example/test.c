...
// Function prototypes
void func_with_all_type_struct_param(struct_with_all_type_fields s);

// Add this function prototype near the top of the file
int func_with_all_type_params(
    ...
    int* slice, int slice_len, int arr[3], e arr2[3],
    char* s, e e,
...
void func_struct_params(tiny_struct t, small_struct s, mid_struct m, big_struct b) {
    // Expected:
...
void func_struct_ptr_params(tiny_struct* t, small_struct* s, mid_struct* m, big_struct* b) {
    // Expected:
    //   all variables: t s m b global_int global_struct global_struct_ptr
    //   t->i: 1
    //   s->i: 2
...
void Test() {
    ...
    func_with_all_type_params(s_all.i8, s_all.i16, s_all.i32, s_all.i64,
                              ...
                              s_all.slice, s_all.slice_len, s_all.arr, s_all.arr2,
                              s_all.s, s_all.e,
...
int func_with_all_type_params(
    ...
    // Expected:
    //   all variables: i8 i16 i32 i64 i u8 u16 u32 u64 u f32 f64 b c64 c128 slice arr arr2 s e f pf pi
    //   i32: 3
    //   i64: 4
    //   i: 5
    //   u32: 8
    ...
    //   u16: 7
    //   b: true
    printf("%d %d %d %lld %d %u %u %u %llu %u %f %f %d %f %f %p %d %d %d %d %s %d %p %p %p\n",
           i8, i16, i32, i64, i, u8, u16, u32, u64, u, f32, f64, b,
           crealf(c64), crealf(c128),
           (void*)slice, slice_len, arr[0], arr2[0].i, e.i,
